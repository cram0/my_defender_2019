...
void i_choice_menu(choice_menu *choice_menu)
{
    ...
    choice_menu->map1_name_holder = set_simple_entity("img/menu_scene/choice_menu/map_name_holder.png", (sfFloatRect){385, 500, 334, 50});
    choice_menu->map2_name_holder = set_simple_entity("img/menu_scene/choice_menu/map_name_holder.png", (sfFloatRect){785, 500, 334, 50});
    choice_menu->map3_name_holder = set_simple_entity("img/menu_scene/choice_menu/map_name_holder.png", (sfFloatRect){1185, 500, 334, 50});
